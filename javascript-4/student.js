...
const me = {
    firstName: 'Alex',
    superHeroName: 'Chicken Tender Tyrant Alex',
    homeTown: 'Eagle',
    superPowers: ['Smugness', 'Quips', 'Eating Them Tenders'],
    superPowerXP: function() {
        return Math.floor(Math.random() * 100) + 1
    },
    promileImage: `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg`
}
// CODE HERE
